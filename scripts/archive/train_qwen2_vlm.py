#!/usr/bin/env python3
"""
Training script for Qwen2-VL Vision-Language Models
Supports Qwen2.5-VL-7B with DeepSpeed and multi-GPU training
"""
...
class VLMDataCollator:
    ...
    def __call__(self, features):
        ...
        # Process batch with Qwen2-VL processor
        texts = []
        image_inputs = []
        ...
        for messages in messages_batch:
            ...
            # Process images
            image_inputs_single, _ = process_vision_info(messages)
            image_inputs.extend(image_inputs_single)
