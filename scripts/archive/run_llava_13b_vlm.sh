...
# Training script for LLaVA-1.5-13B Vision-Language Model on Flickr8k dataset
...
mkdir -p ../../../outputs/llava-13b-vlm-flickr8k

# Run training with DeepSpeed ZeRO-3
deepspeed ../../training/llava_vlm_training_production.py \
  ...
  --output_dir ../../../outputs/llava-13b-vlm-flickr8k \
