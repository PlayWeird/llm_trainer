...
# Test training script for Qwen2.5-32B-Instruct
# Optimized for 3x RTX 3090 GPUs with aggressive memory optimization
# Uses small dataset subset for quick validation
...
OUTPUT_DIR="$PROJECT_ROOT/outputs/qwen25-32b-test"
...
# Log system info
echo "=========================================="
echo "Starting Qwen2.5-32B-Instruct TEST training"
echo "=========================================="
...
# Run with DeepSpeed - aggressive memory optimization for 32B model
