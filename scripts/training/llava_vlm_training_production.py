#!/usr/bin/env python3
"""
Training script for LLaVA Vision-Language Models
Supports LLaVA-1.5 models with DeepSpeed and multi-GPU training
"""
...
def main():
    ...
    if model_args.use_lora:
        ...
        peft_config = LoraConfig(
            task_type=TaskType.FEATURE_EXTRACTION,  # LLaVA uses this task type
            r=model_args.lora_r,
