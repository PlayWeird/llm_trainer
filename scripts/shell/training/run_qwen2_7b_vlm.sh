...
# Training script for Qwen2.5-VL-7B Vision-Language Model on Flickr8k dataset
...
mkdir -p ../../../outputs/qwen2-7b-vlm-flickr8k

# Run training with DeepSpeed ZeRO-3
deepspeed ../../training/train_qwen2_vlm.py \
  ...
  --output_dir ../../../outputs/qwen2-7b-vlm-flickr8k \
