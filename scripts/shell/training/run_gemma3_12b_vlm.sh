...
# Training script for Gemma-3-12B Vision-Language Model on Flickr8k dataset
...
mkdir -p ../../../outputs/gemma3-12b-vlm-flickr8k
...
deepspeed ../../training/train_gemma3_vlm.py \
  ...
  --output_dir ../../../outputs/gemma3-12b-vlm-flickr8k \
